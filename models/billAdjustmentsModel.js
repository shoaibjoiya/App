...
const billAdjustmentsSchema = mongoose.Schema({
  ...
  adujstid: { type: Number, required: true },
  ...
  notes: { type: String },
  adjustcart: { type: Array, required: true },
  userid: { type: mongoose.Schema.Types.ObjectId, ref: 'userModel', required: true },
  sellerid: { type: mongoose.Schema.Types.ObjectId, ref: 'sellerModel', required: true }
}, { timestamps: true });

const billAdjustmentsModel = mongoose.model("billAdjustmentsModel", billAdjustmentsSchema);

export default billAdjustmentsModel;
